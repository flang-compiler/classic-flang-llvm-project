...
// CHECK-SVE2-REVERT-SAME: "-target_features" "+neon,-sve2"
// CHECK-SVE2-AES:  "{{.*}}flang2"
// CHECK-SVE2-AES-SAME: "-target_features" "+neon,+sve2-aes"
// CHECK-SVE2-SM4: "{{.*}}flang2"
// CHECK-SVE2-SM4-SAME: "-target_features" "+neon,+sve2-sm4"
// CHECK-SVE2-SHA3: "{{.*}}flang2"
// CHECK-SVE2-SHA3-SAME: "-target_features" "+neon,+sve2-sha3"
// CHECK-SVE2-BITPERM-REVERT: "{{.*}}flang2"
// CHECK-SVE2-BITPERM-REVERT-SAME: "-target_features" "+neon,-sve2-bitperm"
// CHECK-SVE2-IMPLY: "{{.*}}flang2"
// CHECK-SVE2-IMPLY-SAME: "-target_features" "+neon,+sve2"
// CHECK-SVE2-CONFLICT-REV: "{{.*}}flang2"
// CHECK-SVE2-CONFLICT-REV-SAME: "-target_features" "+neon,-sve,+sve2"
// CHECK-SVE-SVE2: "{{.*}}flang2"
// CHECK-SVE-SVE2-SAME: "-target_features" "+neon,+sve,+sve2"
// CHECK-SVE2-BITPERM: "{{.*}}flang2"
// CHECK-SVE2-BITPERM-SAME: "-target_features" "+neon,+sve2-bitperm"
// CHECK-SVE-SUBFEATURE-CONFLICT-REV: "{{.*}}flang2"
// CHECK-SVE-SUBFEATURE-CONFLICT-REV-SAME: "-target_features" "+neon,-sve,+sve2-aes"
// CHECK-SVE2-SUBFEATURE-CONFLICT:  "{{.*}}flang2"
// CHECK-SVE2-SUBFEATURE-CONFLICT-SAME: "-target_features" "+neon,+sve2-sm4,-sve2"
// CHECK-SVE2-SUBFEATURE-MIX: "{{.*}}flang2"
// CHECK-SVE2-SUBFEATURE-MIX-SAME: "-target_features" "+neon,+sve2-bitperm,-sve2-aes"
// CHECK-SVE2-SM4-REVERT: "{{.*}}flang2"
// CHECK-SVE2-SM4-REVERT-SAME: "-target_features" "+neon,-sve2-sm4"
// CHECK-SVE2-SHA3-REVERT: "{{.*}}flang2"
// CHECK-SVE2-SHA3-REVERT-SAME: "-target_features" "+neon,-sve2-sha3"
// CHECK-SVE2-AES-REVERT: "{{.*}}flang2"
// CHECK-SVE2-AES-REVERT-SAME: "-target_features" "+neon,-sve2-aes"
